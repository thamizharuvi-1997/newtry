...
<div class="con">
	<h3 style="font-size: 30px; margin-left: 30px;">  2. PHP server scripts are surrounded by delimiters, which?</h3>
	<hr>
	<div>
...
<a style="color: white; text-decoration: none;"  href="next3.php" > <input id="button" type="submit" name="submit"> Next Question</a>
 </form>
	</div>
