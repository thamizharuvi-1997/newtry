...
<body>
	<form method="post">
		<div class="container">
			...
			<input type="text" class="username" name="username" placeholder="User" > <br>
			<input  type="password" class="password" name="password" placeholder="....."><br>
			<button class="submit btn btn-primary submit" style="width: 455px; height: 40px;" type="submit" name="submit"><a href="exam1.php" style="text-decoration: none; color: white;"> Submit</a></button><br>
			<hr>
