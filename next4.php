...
<div class="con">
	<h3 style="font-size: 30px; margin-left: 30px;">  4. All variables in PHP start with which symbol?</h3>
	<hr>
	<div>
<form action="next5.php" method="post">
		<p><input type="radio" name="lang[]" value="a" required=""> & </p>
		<p><input type="radio" name="lang[]" value="b" required="">   $  <br></p>
		<p><input type="radio" name="lang[]" value="c" required=""> !  <br></p>
		<p><input type="radio" name="lang[]" value="d" required="">%  <br></p>
		
		
<a style="color: white; text-decoration: none;"  href="next5.php" > <input id="button" type="submit" name="submit"> Next Question</a>
 </form>
	</div>
